                ...
                <div class="row">
                    <div class="col-lg-12 z-index-2 relative ">
                        <div class="title-inner center">
                            <h1 class="title text-white mb-18">Team Member</h1>
            ...
            <div class="tf-container">
                ...
                <div class="row mb-40">
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="">Bilal Murtaza</a></h4>
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="">Rizwan Saleem</a></h4>
                                <p class="job">CTO</p>
                            </div>
                            <div class="image relative">
                                <a href="">
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="team-details.html">Muhammad Ibrahim</a></h4>
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="team-details.html">Sarmad Shehroz</a></h4>
                                <p class="job">Flutter Developer</p>
                            </div>
                            <div class="image relative">
                                <a href="team-details.html">
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="team-details.html">Muhammad kashif</a></h4>
                                <p class="job">Flutter Developer</p>
                            </div>
                            <div class="image relative">
                                <a href="team-details.html">
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="team-details.html">Abdul Saboor</a></h4>
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="team-details.html">Hasseb Ur Rehman</a></h4>
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="team-details.html">Muhammad Jameel</a></h4>
                                <p class="job">Full Stack Developer</p>
                            </div>
                            <div class="image relative">
                                <a href="team-details.html">
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="team-details.html">Saqlain Mirza</a></h4>
                                <p class="job">Design Head</p>
                            </div>
                            <div class="image relative">
                                <a href="team-details.html">
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-30">
                        <div class="tf-team">
                            <div class="content">
                                <h4 class="title"><a href="team-details.html">Kamran Ibrahim</a></h4>
                                <p class="job">Flutter Developer</p>
                            </div>
                            <div class="image relative">
                                <a href="team-details.html">
